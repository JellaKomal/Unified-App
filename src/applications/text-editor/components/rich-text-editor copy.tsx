...
export function RichTextEditorDemo({
  ...
  return (
    <div
      className={cn(
        "relative max-h-[calc(100vh-2rem)] w-full overflow-hidden overflow-y-auto",
        className
      )}
    >
      ...
      <div className="flex gap-2">
        <ScrollWrapper className="h-[calc(100vh-5.5rem)] mt-2 w-[92%]">
          <EditorContent
            editor={editor}
            className=" min-h-full w-full cursor-text !p-0 sm:p-6 text-sm"
          />
        </ScrollWrapper>
        <ScrollWrapper className="h-[calc(100vh-5.5rem)] mt-2 w-[8%] text-[2px]">
